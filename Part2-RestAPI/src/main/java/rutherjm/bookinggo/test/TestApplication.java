...
public class TestApplication {
    ...
    public static void main(String[] args) {
        ...
        while(true)
        {
            ...
            minimumCapacity = getIntegerValue(input);
     ...
     */
    private static int getIntegerValue(Scanner in)
    {
        String input;
        while(true) //keep looping until we convert a number to integer successfully.
        {
            input = in.next();
            try
            {
